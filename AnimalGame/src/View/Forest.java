...
public class Forest extends JFrame implements KeyListener{

	private JPanel contentPane;
		private ImageIcon fo_img = new ImageIcon("./image/forest.png");
	private JLabel fo = new JLabel(fo_img);
	private JLabel label_sub;
	private JLabel c = new JLabel("./image/PetShop.png");
	...
	public Forest() {
		...
		try {
			img = ImageIO.read(new File("./image/Forest.png"));
	...
	public void goMain() {
		 if(x == 460 && y == 315) {
         	   ...
         	   new MainView(170,405).setVisible(true);
		 }
    ...
    public void paint(Graphics g) {
        ...
        image = Toolkit.getDefaultToolkit().getImage("./image/헌터.png"); 
           ...
           g.drawImage(image,
                        x - image.getWidth(this) / 2 + 300 ,
                        y - image.getHeight(this) / 2 - 240 , this);
    }
