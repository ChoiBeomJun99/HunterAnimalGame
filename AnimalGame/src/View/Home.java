...
public class Home extends JFrame implements KeyListener{
	...
	public Home() {
		...
		try {
			img = ImageIO.read(new File("./image/Home.png"));
	...
	public void goMain() {
		 if(x >= 400 && x<= 410 && y == 325) {
       	   this.setVisible(false);
       	   new MainView(650,435).setVisible(true);
		 }
	}
	@Override
    ...
    public void paint(Graphics g) {
        ...
        image = Toolkit.getDefaultToolkit().getImage("./image/헌터.png"); 
           ...
           g.drawImage(image,
                        x - image.getWidth(this) / 2+10,
                        y - image.getHeight(this) / 2 - 200, this);
    }
