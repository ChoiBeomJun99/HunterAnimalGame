...
public class PetShop extends JFrame implements KeyListener{
	...
	public PetShop() {
		...
		try {
			img = ImageIO.read(new File("./image/PetShop.png"));
	...
	public void goMain() {
		 if(x ==420 && y >= 285 && y <=335) {
       	   this.setVisible(false);
       	   new MainView(670,575).setVisible(true);
		 }
	}
	@Override
    ...
    public void paint(Graphics g) {
        ...
        image = Toolkit.getDefaultToolkit().getImage("./image/헌터.png"); 
           ...
           g.drawImage(image,
                        ...
                        y - image.getHeight(this) / 2 + 20, this);
    }
