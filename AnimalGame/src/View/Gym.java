...
public class Gym extends JFrame implements KeyListener{
	...
	public Gym() {
		...
		try {
			img = ImageIO.read(new File("./image/Gym.png"));
	...
	public void goMain() {
		 if(x >= 390 && x<= 400 && y == 325) {
        	   this.setVisible(false);
        	   new MainView(600,275).setVisible(true);
		 }
	}
	@Override
    ...
    public void paint(Graphics g) {
        ...
        image = Toolkit.getDefaultToolkit().getImage("./image/헌터.png"); 
           ...
           g.drawImage(image,
                        x - image.getWidth(this) / 2+20,
                        y - image.getHeight(this) / 2+220, this);
    }
